...
**Quanto?** | <ol><li> Não possuimos informações em relação ao orçamento necessário para a manutenção/criação do sistema. </li><li> O projeto será voluntário.</li> </ol>
...
* [RF6] O **sistema** deve possuir um botão para realizar a exportação para CSV, PDF e PNG
